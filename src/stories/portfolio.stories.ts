...
const meta: Meta<typeof Portfoliograph> = {
...
type Story = StoryObj<typeof Portfoliograph>;

// Sample data (subset of your original data for simplicity)
...
export const CustomColors: Story = {
  args: {
    ...
    color: {
      lonecomplete: "#FF5733",
      propertysold: "#33FF57",
      propertyadded: "#3357FF",
      investmentopportunity: "#FFFF33",
      projectedvalue: "#FF33A1",
      outstandingloan: "#33FFFF",
      equity: "#A133FF",
    },
  },
};
